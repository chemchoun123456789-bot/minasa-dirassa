...
function animateStars() {
  ...
  // نفس قيم الأصل بالضبط لكن بـ rgba لإبقاء الأعلى أسود
  ...
  glow.addColorStop(0, "rgba(26, 58, 110, 1)"); // #1a3a6e
  glow.addColorStop(0.4, "rgba(10, 20, 40, 0.75)"); // #0a1428 مخفف
  glow.addColorStop(0.7, "rgba(5, 8, 16, 0.3)"); // #050810 شفاف
