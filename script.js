...
window.renderList = function (type) {
  ...
  if (items.length === 0) {
    list.innerHTML =
      '<div class="empty-state">' +
      '<div class="es-icon-wrap">' +
      '<svg viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4"/></svg>' +
      "</div>" +
      '<div class="es-title">ما في مهام — خذ استراحة ☕</div>' +
      '<div class="es-sub">أضف مهمتك الأولى وابدأ يومك بخطوة واثقة!</div>' +
      "</div>";
