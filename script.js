...
function togglePassVis(inputId, btn) {
  ...
  var eyeClosed =
    '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/><path d="M10.73 10.73a3 3 0 0 0 4.24 4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>';
  btn.innerHTML = show ? eyeClosed : eyeOpen;
  var svg = btn.querySelector("svg");
  if (svg) {
    svg.classList.remove("pw-anim-in");
    void btn.offsetWidth;
    svg.classList.add("pw-anim-in");
  }
  btn.setAttribute(
    "aria-label",
...
function _enterAbsFocus() {
  ...
  if (btn && typeof _setAbsPauseBtnState === "function")
    _setAbsPauseBtnState(false);
...
function toggleTimer() {
  if (isRunning) {
    ...
    if (absPauseBtn && typeof _setAbsPauseBtnState === "function")
      _setAbsPauseBtnState(true);
  } else {
